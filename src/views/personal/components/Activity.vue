  ...
  <div class="user-activity">
    <div class="post">
      <div class="user-block">
        <img class="img-circle" :src="'https://i.endpot.com/image/GTG3P/avatar.jpg'+avatarPrefix">
        <span class="username text-muted">ajycc20</span>
    ...
    <div class="post">
      <div class="user-block">
        <img class="img-circle" :src="'https://i.endpot.com/image/GTG3P/avatar.jpg'+avatarPrefix">
        <span class="username">ajycc20</span>
